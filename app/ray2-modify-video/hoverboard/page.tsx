...
const steps = [
  {
    ...
    desc: "Capture a video of a friend balancing on top of a short wall or stable surface, pretending to ride and balance back and forth on a floating hoverboard. This initial footage is essential for creating the hoverboard effect.",
    imgs: ["/hoverboard/1.jpeg"]
  },
  {
  ...
  },
  {
    ...
    imgs: ["/hoverboard/5.jpeg"]
  },
  {
    title: "Step 6: Import to Photoshop",
    desc: "Import your Start Frame into Photoshop. This step allows for detailed image editing to refine the hoverboard effect.",
    imgs: ["/hoverboard/6.jpeg"]
  },
  {
    title: "Step 7: Edit with Brush Tool",
    desc: "Using the Brush Tool and Object Selection in Photoshop, edit your scene by adding the shape of the hoverboard and removing the background to create an open space for the surrounding environment. Once completed, export your Edited Start Frame.",
    imgs: ["/hoverboard/7.jpeg"]
  },
  {
  ...
  },
  {
    ...
    imgs: ["/hoverboard/10.jpeg"]
  },
  {
    title: "Step 11: Adjust Strength Slider",
    desc: "Adjust the Strength slider to select an intensity level for the modification. This fine-tunes the hoverboard effect.",
    imgs: ["/hoverboard/11.jpeg"]
  },
  {
    ...
    imgs: ["/hoverboard/12.jpeg"]
  },
  {
    title: "Step 13: Create Modified Video",
    desc: "Tap the Create button in the composer to make your hoverboard modified video come to life. This final step completes the process.",
    imgs: ["/hoverboard/13.jpeg"]
  }
]
...
export default function HoverboardPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <Head>
        <title>How to Create a Hoverboard Video with Luma AI's Modify Video Feature</title>
        <meta name="description" content="Learn how to create a hoverboard video using Luma AI's Modify Video feature with Ray2. This step-by-step tutorial covers capturing video, using Dream Machine, Photoshop, Midjourney, and more to transform a simple scene into a futuristic hoverboard ride." />
        <meta name="keywords" content="Luma AI, Modify Video, hoverboard video, video editing tutorial, Dream Machine, Photoshop, Midjourney, Ray2, video effects, SEO-friendly tutorial" />
      </Head>
      <Header />
      <main className="flex-1 bg-gradient-to-br from-cyan-50 to-blue-50">
        <article className="container mx-auto px-4 py-16 max-w-2xl" itemScope itemType="https://schema.org/Article">
          <h1 className="text-3xl md:text-4xl font-bold text-cyan-700 mb-4 text-center" itemProp="headline">How to Create a Hoverboard Video with Luma AI's Modify Video Feature</h1>
          <h2 className="text-lg md:text-xl text-gray-700 mb-8 text-center font-medium" itemProp="description">Follow this detailed tutorial to learn how to create a hoverboard video using Luma AI's Modify Video feature with Ray2. Each step is illustrated with images to guide you through the process of transforming a simple scene into a futuristic hoverboard ride.</h2>
          <meta itemProp="keywords" content="Luma AI, Modify Video, hoverboard video, video editing tutorial, Dream Machine, Photoshop, Midjourney, Ray2, video effects, SEO-friendly tutorial" />
