...
const steps = [
  {
    ...
    desc: "Capture a video of yourself or a friend wearing a towel or a blanket as a cape blowing in the wind. This initial footage is essential for creating the superhero effect.",
    imgs: ["/superhero/1.jpeg"]
  },
  {
  ...
  },
  {
    ...
    imgs: ["/superhero/8.jpeg"]
  },
  {
    title: "Step 9: Adjust Strength Slider",
    desc: "Adjust the Strength slider to select an intensity level for the modification. This fine-tunes the superhero effect.",
    imgs: ["/superhero/9.jpeg"]
  },
  {
    ...
    imgs: ["/superhero/10.jpeg"]
  },
  {
    title: "Step 11: Create Modified Video",
    desc: "Tap the Create button in the composer to make your superhero modified video come to life. This final step completes the process.",
    imgs: ["/superhero/11.jpeg"]
  }
]
...
export default function SuperheroPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <Head>
        <title>How to Create a Superhero Video with Luma AI's Modify Video Feature</title>
        <meta name="description" content="Learn how to create a superhero video using Luma AI's Modify Video feature. This step-by-step tutorial covers capturing video, using Dream Machine, Midjourney, and more to transform a simple scene into an epic superhero experience." />
        <meta name="keywords" content="Luma AI, Modify Video, superhero video, video editing tutorial, Dream Machine, Midjourney, video effects, SEO-friendly tutorial" />
      </Head>
      <Header />
      <main className="flex-1 bg-gradient-to-br from-cyan-50 to-blue-50">
        <article className="container mx-auto px-4 py-16 max-w-2xl" itemScope itemType="https://schema.org/Article">
          <h1 className="text-3xl md:text-4xl font-bold text-cyan-700 mb-4 text-center" itemProp="headline">How to Create a Superhero Video with Luma AI's Modify Video Feature</h1>
          <h2 className="text-lg md:text-xl text-gray-700 mb-8 text-center font-medium" itemProp="description">Follow this detailed tutorial to learn how to create a superhero video using Luma AI's Modify Video feature. Each step is illustrated with images to guide you through the process of transforming a simple scene into an epic superhero experience.</h2>
          <meta itemProp="keywords" content="Luma AI, Modify Video, superhero video, video editing tutorial, Dream Machine, Midjourney, video effects, SEO-friendly tutorial" />
